...
namespace CodeBase {
	...
	public class Logger{
		...
		///<summary>Specifies the current severity. Messages logged with this instance of the logger are logged with this severity.</summary>
		public Severity curSev=Severity.DEBUG;
		...
		public bool Log(string message){
			return Log(null,"",message,false);
		}

		public bool LogMB(string message) {
			return Log(null,"",message,true);
		}

		public bool Log(Object sender,string sendingFunctionName,string message){
			return Log(sender,sendingFunctionName,message,false);
		}

		public bool LogMB(Object sender,string sendingFunctionName,string message) {
			return Log(sender,sendingFunctionName,message,true);
		}
